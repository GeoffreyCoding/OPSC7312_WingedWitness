...
import com.example.opsc7312_wingedwitness.databinding.ActivityNavigationBinding
    ...
    */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mapView.getMapboxMap().loadStyleUri(NavigationStyles.NAVIGATION_DAY_STYLE) {
            ...
            val endLocation = navigationLocationProvider.lastLocation
            val endPoint = endLocation?.let {
